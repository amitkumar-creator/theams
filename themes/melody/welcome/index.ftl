...
<html>
<head>
    <title>Welcome to Melody</title> <!--${productNameFull}-->
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/melody.svg" alt="${productName}" border="0" />
        <h1>Welcome to <strong>Melody</strong></h1> <!--${productNameFull}-->
      </div>
      <div class="row">
        ...
        <#if properties.displayCommunityLinks = "true">
          <div class="card-pf h-m">
            <h3><a href="http://www.keycloak.org"><img src="welcome-content/keycloak-project.png">Melvault Project <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
          <div class="card-pf h-m">
      ...
      <div class='footer'>
        <#if properties.displayCommunityLinks = "true">
        <a href="http://www.mevault.com"><img src="welcome-content/mevault.jpg" alt="JBoss and JBoss Community"></a>
        </#if>
      </div>
    </div>
  </div>

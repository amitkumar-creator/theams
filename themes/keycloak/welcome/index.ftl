  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        ...
        <h1>Welcome to <strong>Melody</strong></h1>
      </div>
      <div class="row">
            ...
            <#elseif bootstrap>
                ...
                <#else>
                    <p class="welcome-message">
                        ...
                        <br>or use the add-user-melvault script.
                    </p>
                </#if>
            </#if>
        ...
        <#if properties.displayCommunityLinks = "true">
          <div class="card-pf h-m">
            <h3><a href="http://www.keycloak.org"><img src="welcome-content/keycloak-project.png">Melody Project <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
          <div class="card-pf h-m">
